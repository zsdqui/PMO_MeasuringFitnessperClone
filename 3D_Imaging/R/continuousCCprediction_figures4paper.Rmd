...
# @Noemi: what are the units for volume and area?
# verify meanings of count (ie. count of cytoplasm)
descriptions <- c(
  "volume of cytoplasm",
  ...
  "count of cytoplasm: number of independent segments of cytoplasm",   # !!
  "count of mitochondria: number of individual mitochondria",          # !!
  "slice depth",
  "area of cell",
  "volume of cell",
  ...
  "sma cytoplasm",                                                     # !!
  "csf cytoplasm",                                                     # !!
  "MinDist_cytoplasm.p_mito.p",                                        # !!
  "MaxDist_cytoplasm.p_mito.p",                                        # !!
  "MedianDist_cytoplasm.p_mito.p",                                     # !!
  "MinDist_cytoplasm.p_nucleus.p",                                     # !!
  "MaxDist_cytoplasm.p_nucleus.p",                                     # !!
  "MedianDist_cytoplasm.p_nucleus.p",                                  # !!
  ...
  "sma mitochondria",                                                  # !!
  "csf mitochondria",                                                  # !!
  "MinDist_mito.p_nucleus.p",                                          # !!
  "MaxDist_mito.p_nucleus.p",                                          # !!
  "MedianDist_mito.p_nucleus.p",                                       # !!
  ...
  "pixel count per mitochondria",                                      # how is this different from the other pixels per mitochondria
...
table <- cbind(features, descriptions)
colnames(table) <- c("cell feature","description")
print(xtable(table, type = "latex"), file = tabname)
```
