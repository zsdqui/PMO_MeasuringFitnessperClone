...
hm=heatmap.2(as.matrix(hm_df), trace="n", margins = c(19.7, 31.9), 
...
png(figname, width = 2500,height = 2500)
eval(hm$call)
dev.off()
la=plotPNGorTIF(figname)
...
```{r}
panels = list(Fig1 = c("A", "B", "C", "D", "E","G"), Fig3 = c("A", "B", "C", "D"), Fig4 = c("A", "B", "C", "D", "E", "F"), Fig5 = c("A", "B", "C"), Fig2 = c("A", "B", "C", "D", "E"))
plots = list()
