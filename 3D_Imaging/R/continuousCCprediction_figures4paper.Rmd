...
la=plotPNGorTIF(paste0(OUTFIGS, filesep, "Fig2B_2024-06-13.png"))
la=plotPNGorTIF(paste0(OUTFIGS, filesep, "Fig2C_2024-06-13.png"))
```
...
for(coi in unique(target_df$id)){
  ...
  png(paste0(OUTFIGS, filesep, "Fig3E_", coi, ".png"), width = 600, height = 600)
...
```{r}
panels = list(Fig1 = c("A", "B", "C", "D", "E","G"), Fig2 = c("A", "B", "C", "D"), Fig3 = c("A", "B", "C", "D","F"), Fig4 = c("A", "B", "C"), Fig5 = c("A", "B", "C", "D", "E"))
plots = list()
